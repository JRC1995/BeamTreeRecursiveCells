...
class CRvNN_worst_config(BiCell_config):
    def __init__(self):
        super().__init__()
        self.encoder_type = "CRvNN_worst"
        self.model_name = "(CRvNN_worst)"
...
class DiffSortBeamTreeCell_config(BeamTreeCell_config):
    def __init__(self):
        super().__init__()
        self.num_workers = 0
