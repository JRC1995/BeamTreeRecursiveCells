...
SEED = 101
dev_keys = ["normal"]
test_keys = ["dg8", "LRA", "iid_arg", "ood_10arg", "ood_15arg",
             "200_300", "300_400", "400_500", "500_600", "600_700", "700_800", "800_900", "900_1000"]
np.random.seed(SEED)
random.seed(SEED)
max_seq_len = 100

train_path = Path('../data/listops/train_ndr100.tsv')
dev_path = {}
dev_path["normal"] = Path('../data/listops/dev_ndr100.tsv')
test_path = {}
test_path["dg8"] = Path('../data/listops/test_ndr100.tsv')
...
Path('../processed_data/listops_ndr100/').mkdir(parents=True, exist_ok=True)

train_save_path = Path('../processed_data/listops_ndr100/train.jsonl')
dev_save_path = {}
for key in dev_keys:
    dev_save_path[key] = Path('../processed_data/listops_ndr100/dev_{}.jsonl'.format(key))
test_save_path = {}
for key in test_keys:
    test_save_path[key] = Path('../processed_data/listops_ndr100/test_{}.jsonl'.format(key))

metadata_save_path = fspath(Path("../processed_data/listops_ndr100/metadata.pkl"))
