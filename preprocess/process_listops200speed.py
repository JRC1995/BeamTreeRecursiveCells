...
train_path = Path('../data/listops/test_200_300.tsv')
Path('../processed_data/listops200speed/').mkdir(parents=True, exist_ok=True)

train_save_path = Path('../processed_data/listops200speed/train.jsonl')
dev_save_path = {}
for key in dev_keys:
    dev_save_path[key] = Path('../processed_data/listops200speed/dev_{}.jsonl'.format(key))
test_save_path = {}
for key in test_keys:
    test_save_path[key] = Path('../processed_data/listops200speed/test_{}.jsonl'.format(key))

metadata_save_path = fspath(Path("../processed_data/listops200speed/metadata.pkl"))
